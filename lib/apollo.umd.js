(function (global, factory) {
	...
	(factory((global.apollo = {}),null,global.graphql_language_printer,global.Redux,global.graphqlAnywhere,global.$$observable));
        ...
        return new Promise(function (resolve, reject) {
            middlewarePromise.then(function (batchRequestAndOptions) {
                return _this.batchedFetchFromRemoteEndpoint(batchRequestAndOptions)
                    ...
                    if (!httpResponse.ok) {
                        return _this.applyBatchAfterwares({ responses: [httpResponse], options: batchRequestAndOptions.options })
                            .then(function () {
...
function data(previousState, action, config) {
    ...
    if (isQueryResultAction(action)) {
        ...
        if (!constAction.result.errors) {
            ...
            if (updateQueries_1) {
                Object.keys(updateQueries_1).filter(function (id) { return updateQueries_1[id]; }).forEach(function (queryId) {
...
var QueryStore = (function () {
    ...
    QueryStore.prototype.initQuery = function (query) {
        ...
        if (typeof query.fetchMoreForQueryId === 'string') {
            this.store[query.fetchMoreForQueryId].networkStatus = exports.NetworkStatus.fetchMore;
        }
    };
    ...
    QueryStore.prototype.markQueryResultClient = function (queryId, complete) {
        ...
        this.store[queryId].networkError = null;
        this.store[queryId].previousVariables = null;
        this.store[queryId].networkStatus = complete ? exports.NetworkStatus.ready : exports.NetworkStatus.loading;
    };
...
var QueryScheduler = (function () {
    ...
    QueryScheduler.prototype.checkInFlight = function (queryId) {
        var queries = this.queryManager.queryStore;
        return queries.get(queryId) && queries.get(queryId).networkStatus !== exports.NetworkStatus.ready;
    };
...
var ApolloClient$1 = (function () {
    function ApolloClient(options) {
        ...
        if (networkInterface && typeof networkInterface.request === 'function') {
            this.networkInterface = __assign$11({}, networkInterface, { query: function (request) { return new Promise(function (resolve, reject) {
