...
var MockObservableNetworkInterface = (function () {
    function MockObservableNetworkInterface(mockedResponses) {
        this.mockNetworkInterface = new MockNetworkInterface(mockedResponses);
    }
    MockObservableNetworkInterface.prototype.addMockedResponse = function (mockedResponse) {
        this.mockNetworkInterface.addMockedResponse(mockedResponse);
    };
    MockObservableNetworkInterface.prototype.request = function (request) {
        var _this = this;
        return new Observable(function (_a) {
            var onNext = _a.next, onError = _a.error, onComplete = _a.complete;
            var result = _this.mockNetworkInterface.query(request);
    ...
    return MockObservableNetworkInterface;
}());
export { MockObservableNetworkInterface };
var MockSubscriptionNetworkInterface = (function (_super) {
    ...
    MockSubscriptionNetworkInterface.prototype.fireResult = function (id) {
        ...
        if (this.mockedSubscriptionsById.hasOwnProperty(id.toString())) {
            ...
            setTimeout(function () {
                handler(response_1.error, response_1.result ? response_1.result.data : undefined);
...
export { MockBatchedNetworkInterface };
