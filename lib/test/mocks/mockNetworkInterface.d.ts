import { NetworkInterface, ObservableNetworkInterface, BatchedNetworkInterface, Request, SubscriptionNetworkInterface } from '../../src/transport/networkInterface';
...
export declare function mockObservableNetworkInterface(...mockedResponses: MockedResponse[]): ObservableNetworkInterface;
...
export declare class MockObservableNetworkInterface implements ObservableNetworkInterface {
    private mockNetworkInterface;
    constructor(mockedResponses: MockedResponse[]);
    addMockedResponse(mockedResponse: MockedResponse): void;
