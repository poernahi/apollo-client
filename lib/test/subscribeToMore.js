...
describe('subscribeToMore', function () {
    ...
    var results = ['Dahivat Pandya', 'Amanda Liu'].map(function (name) { return ({ result: { data: { name: name } }, delay: 10 }); });
    var sub1 = {
        request: {
    ...
    var results4 = ['Vyacheslav Kim', 'Changping Chen'].map(function (name) { return ({ result: { data: { name: name } }, delay: 10 }); });
    var sub4 = {
        request: {
            query: (_e = ["\n        subscription newValues {\n          name\n        }\n      "], _e.raw = ["\n        subscription newValues {\n          name\n        }\n      "], gql(_e)),
        },
